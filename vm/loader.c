...
static int create_zeropage(vm_t *pVM) {
	...
	strcpy(cmd_line,"noapic noacpi pci=conf1 reboot=k panic=1 i8042.direct=1 i8042.dumbkbd=1 i8042.nopnp=1 earlyprintk=serial console=ttyS0 i8042.noaux=1 root=ram0 rw");
